...
class SamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sample" do
    assert_difference('Sample.count') do
      post samples_url, params: { sample: { fuga: @sample.fuga, hoge: @sample.hoge, piyo: @sample.piyo } }
    end
  ...
  test "should update sample" do
    patch sample_url(@sample), params: { sample: { fuga: @sample.fuga, hoge: @sample.hoge, piyo: @sample.piyo } }
